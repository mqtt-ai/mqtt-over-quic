...
meet the demands of modern mobile networks and modern applications.
...
- Mitigate HOLB
  ...
  HOLB only happens to each QUIC stream, but not the entire connection.
...
precedence is given to the latter connection established.
